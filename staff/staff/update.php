...
$dbname = "airline";
	...
	staff.state, staff.city, staff.zip, staff.address, staff.address2, staff.phone, staff.email, staff.homeAirport, airport.name AS aname FROM `staff`, `airport` WHERE staff.homeAirport=airport.aid AND staff.sid=".$sid;
